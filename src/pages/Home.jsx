...
export default function Home() {
  return (
    <>
      <section className="Eslogan text-white text-center d-flex align-items-center justify-content-center" style={{ minHeight: '50vh', background: 'linear-gradient(180deg,#2f8b57,#1f6b43)' }}>
